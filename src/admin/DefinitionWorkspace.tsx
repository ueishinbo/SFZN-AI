...
export default function DefinitionWorkspace({ page, onConfigure, onCollaborate }: { page: 'organizationDefinition' | 'processDefinition'; onConfigure: (position: Position) => void; onCollaborate: () => void }) {
