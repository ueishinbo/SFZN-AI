...
import { BadgeCheck, Boxes, BrainCircuit, CalendarClock, Cpu, FlaskConical, FlaskRound, KeyRound, LayoutDashboard, Network, ShieldCheck, UsersRound } from 'lucide-react'

export type AdminPageId = 'organizationDefinition' | 'processDefinition' | 'overview' | 'roleAgents' | 'processSimulation' | 'processSimulationV2' | 'workingGroupDemo' | 'experts' | 'skills' | 'mcp' | 'models' | 'automation' | 'approvals' | 'organization' | 'roles'
...
export const adminNavigation: AdminNavItem[] = [
  ...
  { id: 'processSimulation', label: '流程仿真', icon: FlaskConical, description: '板块内容待补充' },
  { id: 'processSimulationV2', label: '流程仿真V2', icon: FlaskRound, description: '节点含执行过程与沟通过程两个视图' },
...
export const managementRows: Record<Exclude<AdminPageId, 'overview' | 'roleAgents' | 'processSimulation' | 'processSimulationV2' | 'workingGroupDemo' | 'organizationDefinition' | 'processDefinition'>, Array<[string, string, string]>> = {
