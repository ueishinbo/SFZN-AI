...
import { BadgeCheck, Boxes, CalendarClock, Cpu, KeyRound, LayoutDashboard, Network, ShieldCheck, UsersRound } from 'lucide-react'

export type AdminPageId = 'overview' | 'experts' | 'skills' | 'mcp' | 'models' | 'automation' | 'approvals' | 'organization' | 'roles'
...
export const managementRows: Record<Exclude<AdminPageId, 'overview'>, Array<[string, string, string]>> = {
  ...
  organization: [['研发中心', '42 名成员 · 6 个岗位集', '正常'], ['项目管理部', '28 名成员 · 4 个岗位集', '正常'], ['供应链管理部', '35 名成员 · 5 个岗位集', '正常']],
