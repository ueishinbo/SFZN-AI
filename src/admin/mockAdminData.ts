...
export type AdminPageId = 'overview' | 'roleAgents' | 'experts' | 'skills' | 'mcp' | 'models' | 'automation' | 'approvals' | 'organization' | 'roles'
...
export const managementRows: Record<Exclude<AdminPageId, 'overview' | 'roleAgents'>, Array<[string, string, string]>> = {
